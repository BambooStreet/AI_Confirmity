...
export const baseNegativeCommentsEn: PresetComment[] = [
  {
    ...
    content:
      "I'm against legalization. The state actively helping end someone's life is dangerous on its own imo. You can call it 'self-determination' all you want but at the end of the day it's a system that legally assists suicide. And once that door's open there's no going back. That's exactly why we need to be way more careful here.",
    timeAgo: "32m ago",
    likes: 142,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "I'm opposed to this. From literally first year of med school they drill 'do no harm' into you. Someone who trained their whole life to save patients then taking part in a patient's death goes against the entire point of the job. And fwiw out of all the clinicians I know I've met almost nobody who actually supports this.",
    timeAgo: "1h ago",
    likes: 88,
    isAiGenerated: true,
  },
  ...
  },
  {
    ...
    content:
      "Hard no from me. Look at the Netherlands. Started with terminal patients, now it covers depression and even minors. The 'slippery slope' isn't some hypothetical lol",
    timeAgo: "3h ago",
    likes: 97,
    isAiGenerated: true,
  },
...
export const additionalNegativeCommentsEn: PresetComment[] = [
  ...
  },
  {
    ...
    content:
      "Not on board with this. Social worker here. In the field I see SO many people basically give up treatment because of cost. One round of non-covered chemo can run thousands of dollars. Honestly I'm scared legalization just turns into a system that quietly nudges people toward 'if I die my family won't struggle.'",
    timeAgo: "2h ago",
    likes: 119,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "I'm against it. As someone caring for my parents, this law passing would weigh on me so bad :( It's so obvious they'd land on 'I shouldn't be a burden' and that's the whole problem",
    timeAgo: "2h ago",
    likes: 96,
    isAiGenerated: true,
  },
  ...
  },
  {
    ...
    content:
      "Hard disagree. I'd argue dignity isn't in choosing your own death, it's in building a society that cares for you humanely until the very last moment. Honestly the name 'death with dignity' is kind of a sleight of hand. Strictly speaking it's 'physician-assisted suicide,' the wording just hides what it actually is.",
    timeAgo: "3h ago",
    likes: 82,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "Count me against it. First thing they teach you in med ethics is 'do no harm.' A doctor helping a patient die clashes with the whole point of the job, full stop",
    timeAgo: "4h ago",
    likes: 64,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "No from me on this. When Nazi Germany's euthanasia program (T4) first kicked off, the justification was 'merciful death' too. It always starts with 'compassion.' We all know how that one ended. History repeats itself.",
    timeAgo: "4h ago",
    likes: 105,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "I'm opposed. Psychiatrist here. When my patients say they want to die, 99% of the time what they actually mean is 'I want out of this suffering,' not 'I genuinely want to be dead.' And saying this responsibly: the answer is to treat the cause of the suffering, not to end the person.",
    timeAgo: "5h ago",
    likes: 178,
    isAiGenerated: true,
  },
  ...
  },
  {
    ...
    content:
      "Hard no. A pharmacist's whole job is making medicine that saves people, not mixing up drugs to kill them. If this gets legalized you'd basically have to rewrite the entire pharmacy code of ethics",
    timeAgo: "6h ago",
    likes: 53,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "I can't get behind this. Honestly, as someone who works in insurance: if this gets legalized it's pretty obvious how the internal guidelines shift. Give it time and somebody's putting together a spreadsheet comparing 'cost of treatment vs cost of assisted death.' Capital always 'recommends' the rational choice.",
    timeAgo: "6h ago",
    likes: 88,
    isAiGenerated: true,
  },
  {
    ...
    author: "anon_3492",
    content:
      "Nope, against it. And how do you take responsibility for a misdiagnosis? I've literally seen someone given 6 months live another 10 years",
    timeAgo: "7h ago",
    likes: 134,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "I'm skeptical of this. Psych here. Tons of studies show a big chunk of people asking for assisted death also have untreated major depression. Calling that 'their own free will' while leaving something treatable untreated is exactly how this goes wrong. There's a reason a lot of us argue a psych eval has to come first.",
    timeAgo: "7h ago",
    likes: 76,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "I'm against it. The constitution guarantees a right to life, not a right to die. Good luck getting this past a constitutional challenge",
    timeAgo: "8h ago",
    likes: 61,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "Against it, honestly. I work in a nursing home and you'd be shocked how many seniors barely get any family visits. Loneliness is the real disease here. If 'assisted dying is legal' becomes the background message of society while that's going on, those same seniors get one step closer to 'I guess I can go now.' We should be expanding care, not expanding the exit.",
    timeAgo: "8h ago",
    likes: 144,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "Not sold on this. Pediatrician here. The thing that worries me most is the message that spreads through society when this passes, basically 'if it hurts enough it's ok to die.' And that kind of thing does show up in the stats.",
    timeAgo: "9h ago",
    likes: 79,
    isAiGenerated: true,
  },
  ...
  },
  {
    ...
    content:
      "Not for this. From the research side: once a 'right to die' gets institutionalized, the momentum (and funding) for palliative care research just drains away. When there's a way cheaper exit on the table, who's gonna keep paying for advances in pain management? The better care future patients could've gotten basically just disappears.",
    timeAgo: "12h ago",
    likes: 68,
    isAiGenerated: true,
  },
  {
    ...
    author: "ExGovAdmin",
    content:
      "I'm against it. I don't buy the 'strict review board' promise at all. We all know how committee reviews end up as a formality. Once the applications start piling up it's gonna turn into a rubber stamp that approves anything that checks the paperwork boxes",
    timeAgo: "13h ago",
    likes: 87,
    isAiGenerated: true,
  },
...
export const basePositiveCommentsEn: PresetComment[] = [
  {
    ...
    content:
      "I'm for it. Deciding what happens to my own body, my own life, is like the most basic form of self-determination there is. What's actually weird is that the state gets to block even the choice to die when you're in irreversible suffering. Legalizing this is an expansion of freedom, not a violation of it.",
    timeAgo: "29m ago",
    likes: 158,
    isAiGenerated: true,
  },
  {
    ...
    author: "FrontlineMD",
    content:
      "I support this. Internal med doc, 12 years in. I regularly have to stand there while patients with zero chance of recovery spend days, sometimes weeks, in agony. When medicine has nothing left to give and the patient wants to decide their own ending, helping them do that IS part of care. 'Do no harm' was never about forcing people to suffer for no reason.",
    timeAgo: "1h ago",
    likes: 124,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "Having been through it, I'm for it. Lost my father last year. Stage 4 pancreatic cancer, and the last two months he was barely conscious. Watching him moan the few times he woke up, even maxed out on morphine... I genuinely started questioning whether that was a dignified way for a person to go.\n\nWhile he could still talk he told us 'don't drag this out.' But there's no option for that here so we had no choice but to make him endure all of it. I still don't know if that was the right call. People whose wishes are that clear should at least get a choice.",
    timeAgo: "2h ago",
    likes: 287,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "I'm in favor. A dozen+ countries and US states already do this under strict review. Everyone screams 'slippery slope' but the actual data doesn't back it up. Look it up",
    timeAgo: "3h ago",
    likes: 109,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "I support this. Palliative care resident here. The 'hospice controls most pain' claim is only half true. There are absolutely cases where the pain can't be controlled, and even when it can, a lot of patients face a long stretch of just lying there unconscious.\n\nWhen those patients tell us they want to say goodbye and go while their mind is still clear, it weighs on us so much as clinicians. Expanding palliative care and opening up assisted dying aren't either/or, they need to happen together.",
    timeAgo: "4h ago",
    likes: 233,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "I'm in favor. Human rights aren't just the 'right to be alive,' they're the whole 'right to live like a human being.' Is forcing someone to spend a few more days in extreme pain with no chance of recovery actually protecting their rights? Real dignity is letting people decide the end of their own life imo.",
    timeAgo: "5h ago",
    likes: 116,
    isAiGenerated: true,
  },
...
export const additionalPositiveCommentsEn: PresetComment[] = [
  {
    ...
    author: "anon_user",
    content:
      "I'm on the yes side. Honestly if the person themselves says they can't take it anymore, why does anyone else get to stop them? Strict screening should be enough, no?",
    timeAgo: "14m ago",
    likes: 198,
    isAiGenerated: true,
  },
  ...
  },
  {
    ...
    content:
      "I support this. Before she passed my mom wrote it down in her own hand: 'no life support, take the ventilator out.' But it took forever for that to actually get processed legally, and the whole time she just lay there in exactly the state she never wanted. When someone's wishes are that clear and society still won't honor them... that's the part that felt crueler.",
    timeAgo: "2h ago",
    likes: 88,
    isAiGenerated: true,
  },
  ...
  },
  {
    ...
    content:
      "I'm in favor. Bioethics has been arguing 'sanctity of life (SOL)' vs 'quality of life (QOL)' forever. And the general direction the field has moved is toward weighting the patient's own values and autonomy. The one-size-fits-all 'extend every life no matter what' approach honestly isn't the mainstream position anymore.",
    timeAgo: "3h ago",
    likes: 79,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "I'm a yes on this. Med student here. Patient autonomy was the #1 thing drilled into us. 'Do no harm' was never about forcing pointless life-prolongation.",
    timeAgo: "4h ago",
    likes: 67,
    isAiGenerated: true,
  },
  ...
  },
  {
    ...
    author: "anon_5731",
    content:
      "I'm a yes on this. Everyone brings up misdiagnosis but this only applies to terminal cases w multiple doctors + reflection periods + a psych eval. Hardly a loophole",
    timeAgo: "7h ago",
    likes: 132,
    isAiGenerated: true,
  },
  ...
  },
  {
    ...
    content:
      "I'm in favor. Hospice beds are scarce and not everyone even gets one. And the 'hospice fixes everything' line just isn't true once you've seen the field.",
    timeAgo: "10h ago",
    likes: 96,
    isAiGenerated: true,
  },
  ...
  },
  {
    ...
    author: "DadHadIPF",
    content:
      "Honestly, I'm for it. To everyone saying pain can just be managed with drugs, ok but what about not being able to breathe? My dad had end-stage pulmonary fibrosis and in his last weeks he said every night felt like drowning. Morphine doesn't fully fix that. Once you've watched someone go through suffering that's not just 'pain,' this whole debate looks really different.",
    timeAgo: "14h ago",
    likes: 211,
    isAiGenerated: true,
  },
  {
    ...
    content:
      "I'm for it. I'm a churchgoer so I wrestled with this for a long time. But I realized that believing life is a sacred gift and believing the state should forcibly prolong irreversible suffering are two totally different things. My faith is mine to hold. I don't have the right to write it into law and force it onto someone else's final moments. That's where I landed.",
    timeAgo: "15h ago",
    likes: 134,
    isAiGenerated: true,
  },
  {
    ...
    author: "anon_000",
    content:
      "Personally I'm for it. Most of the people against this have never been through that kind of suffering themselves. Easy to talk when it's not your life",
    timeAgo: "16h ago",
    likes: 167,
    isAiGenerated: true,
  },
